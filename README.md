...
- Danbooru and E621 autocomplete dictionaries can be enabled independently or combined.
...
| **Booru dictionaries** | Enable Danbooru, E621, both merged without duplicate tags, or neither from the popup settings. |
| **Zero external calls** | All data lives in Chrome Storage; nothing ever leaves your browser. |

The bundled E621 dictionary is generated by [DraconicDragon/dbr-e621-lists-archive](https://github.com/DraconicDragon/dbr-e621-lists-archive), snapshot 2026-08-01, post threshold 20, including active and deleted aliases.
